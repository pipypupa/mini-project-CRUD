...
var _postJsDefault = parcelHelpers.interopDefault(_postJs);
var _editJs = require("./api/edit.js");
var _editJsDefault = parcelHelpers.interopDefault(_editJs);
var _deleteJs = require("./api/delete.js");
var _deleteJsDefault = parcelHelpers.interopDefault(_deleteJs);
var _updateLikesJs = require("./api/updateLikes.js");
var _updateLikesJsDefault = parcelHelpers.interopDefault(_updateLikesJs);
var _renderCommentsJs = require("./render/renderComments.js");
var _renderCommentsJsDefault = parcelHelpers.interopDefault(_renderCommentsJs);
var _postCommentsJs = require("./api/postComments.js");
var _postCommentsJsDefault = parcelHelpers.interopDefault(_postCommentsJs);
let postsList = [];
...
document.querySelector("#new-post-form").addEventListener("submit", async (e)=>{
    ...
    await (0, _postJsDefault.default)(postObject);
    await refreshPosts();
    document.querySelector(".modal-backdrop").classList.add("hidden");
    e.target.reset();
});
...
document.querySelector(".posts").addEventListener("click", (e)=>{
    ...
    if (e.target.closest(".like-button")) {
        ...
        (0, _updateLikesJsDefault.default)(likes, id);
    }
...
document.querySelector("#comments-post-form").addEventListener("submit", async (e)=>{
    ...
    await (0, _postCommentsJsDefault.default)(updatedList, commentPostId, comments);
    await refreshPosts();
    document.querySelector(".modal-backdropCommments").classList.add("hidden");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["3OHon","2xGku"], "2xGku", "parcelRequiref851", {})

//# sourceMappingURL=mini-project-CRUD.380419b9.js.map
